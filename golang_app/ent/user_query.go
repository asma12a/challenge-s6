...
func (uq *UserQuery) QueryUserStats() *UserStatsQuery {
	query := (&UserStatsClient{config: uq.config}).Query()
...
func (uq *UserQuery) FirstID(ctx context.Context) (id ulid.ID, err error) {
	var ids []ulid.ID
...
func (uq *UserQuery) FirstIDX(ctx context.Context) ulid.ID {
...
func (uq *UserQuery) OnlyID(ctx context.Context) (id ulid.ID, err error) {
	var ids []ulid.ID
...
func (uq *UserQuery) OnlyIDX(ctx context.Context) ulid.ID {
...
func (uq *UserQuery) IDs(ctx context.Context) (ids []ulid.ID, err error) {
...
func (uq *UserQuery) IDsX(ctx context.Context) []ulid.ID {
	ids, err := uq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withUserStats: uq.withUserStats.Clone(),
...
func (uq *UserQuery) WithUserStats(opts ...func(*UserStatsQuery)) *UserQuery {
	query := (&UserStatsClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withUserStats = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withUserStats; query != nil {
		if err := uq.loadUserStats(ctx, query, nodes,
...
func (uq *UserQuery) loadUserStats(ctx context.Context, query *UserStatsQuery, nodes []*User, init func(*User), assign func(*User, *UserStats)) error {
