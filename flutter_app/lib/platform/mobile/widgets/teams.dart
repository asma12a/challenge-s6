...
class TeamsHandle extends StatefulWidget {
  ...
  final int maxTeams;
  final bool userIsOrganizer;
  final bool userIsCoach;
  // final bool canEdit;
  // final bool canEditStats;
  final Color color;
...
class _TeamsHandleState extends State<TeamsHandle> {
  ...
  Widget build(BuildContext context) {
    ...
    final canEdit = widget.userIsOrganizer || widget.userIsCoach;
                    ...
                    (team) {
                      return Tab(
                        child: Row(
                          children: [
                            Text(team.name),
                            SizedBox(width: canEdit ? 8 : 16),
                            if (canEdit && !widget.isEventFinished) ...[
                              Container(
                                width: 30,
                                height: 30,
